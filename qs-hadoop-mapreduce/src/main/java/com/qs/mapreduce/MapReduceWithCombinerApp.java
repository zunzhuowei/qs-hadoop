 ...
 */
public class MapReduceWithCombinerApp {
...
*/
        ...
        //设置job的处理类
        job.setJarByClass(MapReduceWithCombinerApp.class);
        ...
        //设置combiner处理类
        //逻辑上和reduce是一样的，就是相当于在map本地执行一次reduce 然后再提交给reduce处理
        // 使用场景求和次数等，求平均就不合适了
        job.setCombinerClass(MyReduceer.class);
